...
# Load data
corpus = data_v3.Corpus('./data/outputdata', vocab, words2idx_emb, idx_train, idx_test, idx_val) #改动2 
eval_batch_size = 10
...
# Build the model
model = model.RNNModel(args.model, gn_glove_vecs, ntokens, args.emsize, args.nhid, args.nlayers, args.dropout, args.tied) #ntokens, args.emsize,
if args.cuda:
    model.cuda()
